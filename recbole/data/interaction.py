...
if __name__ == '__main__':
    a = torch.rand(4, 5)
    #c = Interaction({'1': torch.zeros(5), '3': torch.zeros(7), '3': a})
    e = Interaction({'2': torch.zeros(9), '3': torch.zeros(7)})
    #key = list(c)
    print(e)

    # emb = torch.nn.Embedding(5, 10, padding_idx=0)
    ...
    print(list(map(int, list(e))))

   # print(type(list(e.numpy().keys())))
